...
class SacredheartWebUiScreen extends StatefulWidget {
  const SacredheartWebUiScreen({super.key});

  @override
  State<SacredheartWebUiScreen> createState() => _SacredheartWebUiScreenState();
}

class _SacredheartWebUiScreenState extends State<SacredheartWebUiScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Row(
                    children: [
                      Icon(Icons.assignment, color: Color(0xFF7C3AED)),
                      SizedBox(width: 8),
                      Text(
                        'Application Details',
                        style: TextStyle(
